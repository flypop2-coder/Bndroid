# Bndroid OS Project Milestones

This file preserves the long-form milestone history that previously appeared on
the repository home page. For a concise overview, see [README.md](README.md);
for the technical positioning paper, see [WHITEPAPER.md](WHITEPAPER.md).
