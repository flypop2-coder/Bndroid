...
case "$OUTPUT_APK" in
    "$FIXTURE_DIR/androidbox-envelope-demo.apk")
        ...
        ;;
    "$ROOT"/target/androidbox-runtime-install2/*|"$ROOT"/target/androidbox-multipackage4/*|"$ROOT"/target/androidbox-multipackage4-*/*|"$ROOT"/target/androidbox-icon-resources5/*|"$ROOT"/target/androidbox-density-icons7/*|"$ROOT"/target/androidbox-dex-methods8/*|"$ROOT"/target/androidbox-dex-instance9/*|"$ROOT"/target/androidbox-activity-fields10/*|"$ROOT"/target/activity-fields10/*|"$ROOT"/target/androidbox-activity-fields10/*|"$ROOT"/target/activity-state11/*|"$ROOT"/target/string-text12/*|"$ROOT"/target/androidbox-string-text12/*|"$ROOT"/target/string-builder13/*|"$ROOT"/target/androidbox-string-builder13/*|"$ROOT"/target/layout-row14/*|"$ROOT"/target/androidbox-layout-row14/*|"$ROOT"/target/layout-weight15/*|"$ROOT"/target/androidbox-layout-weight15/*|"$ROOT"/target/layout-spacing16/*|"$ROOT"/target/androidbox-layout-spacing16/*|"$ROOT"/target/layout-directional17/*|"$ROOT"/target/androidbox-layout-directional17/*|"$ROOT"/target/layout-size18/*|"$ROOT"/target/androidbox-layout-size18/*|"$ROOT"/target/layout-mixed19/*|"$ROOT"/target/androidbox-layout-mixed19/*) ;;
